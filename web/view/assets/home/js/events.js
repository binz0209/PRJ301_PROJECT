...
function searchProducts(tag, scope) {
    ...
    var scope = scope;
    $.ajax({
        url: "/PRJ301_Group4/SearchServlet",
        type: "get",
        data: {
            txtSearch: text,
            scope: scope
...
function addProductToWishlist(action, product_id) {
    ...
    var productId = product_id;
    $.ajax({
        url: "/PRJ301_Group4/WishlistServlet",
        type: "get",
        data: {
            action: action,
            product_id: productId,
...
function checkDuplicate(input) {
    ...
    $.ajax({
        url: "/PRJ301_Group4/RegisterServlet",
        type: "post",
        data: {
            username: username,
...
function subscribeEmailAtHome(action) {
    ...
    var action = action;
    $.ajax({
        url: "/PRJ301_Group4/EmailServlet",
        type: "get",
        data: {
            email: email,
            action: action
